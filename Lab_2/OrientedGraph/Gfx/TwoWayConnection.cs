...
{
    public class TwoWayConnection : Drawable
    {
        private readonly DoubleSidedArrow _connectionArrow;
        ...
        public TwoWayConnection(Element firstElement, Element secondElement)
        {
